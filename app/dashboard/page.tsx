...
export default function DashboardPage() {
  ...
  const [user, setUser] = useState<{ id: string; username: string; avatar: string | null; joinedAt: string; role?: string } | null>(null);
  ...
  useEffect(() => {
    const updateLimit = () => {
      ...
      const isLimit = recentAbandoned.length >= 2;
                ...
                <div className="max-w-[500px] w-full mx-auto pb-12 space-y-6 animate-fade-in select-none">
                  ...
                  <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-8 text-center space-y-6 backdrop-blur-md relative overflow-hidden">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-400 leading-relaxed font-semibold">
                        Has agotado tus 2 intentos permitidos para hoy. Por favor, espera a que se restablezca tu límite de intentos.
                      </p>
                    </div>
